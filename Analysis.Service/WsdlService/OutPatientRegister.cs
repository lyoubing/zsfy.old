...
[System.Web.Services.WebServiceBindingAttribute(Name="MessageServiceSoap", Namespace="http://www.gzsums.net/noticeService/")]
public interface IMessageServiceSoap {
    ...
    Response messageNotice(Request req);
    ...
    Response messageQuery(Request req);
    ...
    Response messageRecieve(Request req);
}
