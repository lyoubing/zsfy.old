        ...
        public string CreateReportXml(NetScape.AnalysisModel.Order order, NetScape.AnalysisModel.FileConent result, string savePath)
        {
            ...
            XElement root = new XElement("ECGReport",
                ...
                new XElement("VisitNumber", result.Patient.PID.ID),
                 ...
                 new XElement("PatientTypeCode", Common.ConstManager.GetPatientType(order.Patient.PatientType)),
                 new XElement("PatientType", order.Patient.PatientType),
                 new XElement("PatientTypeCodeSystem", GetPatientDomain(order.Patient.PatientType)),
