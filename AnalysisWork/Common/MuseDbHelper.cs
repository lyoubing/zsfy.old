...
{
  public  class MuseDbHelper
    {
        /// <summary>
        /// 获取web.config的连接字符串
        /// </summary>
        private static readonly string connstr =string.Empty;// ConfigurationManager.ConnectionStrings["constr"].ConnectionString;
  ...
  /// <summary>
    ...
    public sealed class SqlHelper
    {
        ...
        {
            return ExecuteScalar(NetScape.AnalysisModel.Profile.ConfigSetting.MuseConnStr, CommandType.Text, sql);
        }
