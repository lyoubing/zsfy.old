...
namespace NetScape.AnalysisModel
{
    public class PatientInfo : BaseObj
    {
        ...
        private BaseObj nurseStation = new BaseObj();
        ...
        private BaseObj dept = new BaseObj();
        ...
        private BaseObj bed = new BaseObj();
        ...
        private ArrayList diagNoses = new ArrayList();

        public ArrayList DiagNoses
        {
            get
            {
                if (diagNoses == null)
		...
		{
            PatientInfo patient = this.MemberwiseClone() as PatientInfo;
            patient.Dept = this.Dept.Clone();
            patient.NurseStation = this.NurseStation.Clone();
            patient.PID = this.PID.Clone();
            patient.Bed = this.Bed.Clone();
            return patient;
		}
